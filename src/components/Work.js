            ...
            <div id="work" className="work-content">
                ...
                <h3 className="work-header2"> React | Redux | Node.js | Express.js | mongo DB | Mongoose | HTML | CSS | JavaScript | ES6 | jQuery | Passport.js | bcrypt.js | Mocha.js | Chai.js | Travis.CI | Heroku | Git | GitHub | Responsive Design | API integration </h3>
                 ...
                 <div className="project-description-content">
                    ...
                    <p className="project-description">Helping users decrease the amount of food waste in the world, Fridgeful allows users to search recipes based on the ingredients in their fridge. Users are able to write comments and save recipes into their own personal database.</p>
                </div>
                <div className="project-content">
                    ...
                    <div className="project-tools-content">
                    <h2>Stack</h2>
                 ...
                 <div className="project-description-content">
                    ...
                    <p className="project-description">BrewTrackr allows users to search for coffee or breweries in any city. Users are able to write their own reviews and save their search results into their own list. Keep track of all your favorite coffee and breweries with BrewTrackr.</p>
                </div>
                ...
                <div className="project-description-content">
                    <h3 className="project-title"> TrekCheck </h3>
                    <p className="project-description">TrekCheck is a responsive web application that allows users to look up both hiking and weather data in a specified location with one quick search. Check the current weather and find the best hiking trails nearby with TrekCheck.</p>
                </div>
                <div className="project-content">
                    <div className="project-image-content">
