                ...
                <div id="about" className="about">
                    <Fade left>
                        <div className="about-content">
                            ...
                            <p className="about-paragraph">I'm a web developer with a knack for Full-stack development based in Los Angeles, California. Originally coming from a Pre-Health background, I later realized that programming is my true passion. In my prior life as a physical therapy aide, I worked and collaborated with professionals to create the best solutions for patients to improve their health. As a developer, I draw on this collaborative and relational experience to excel in teams and build scalable, beautiful applications that solve exciting problems. My goal with all of my projects is to design and code a simple, beautiful user experience with a priority for accessibility. I have a strong desire to continue learning new technologies and I am always looking for ways to make myself and my code more efficient. With a strong grounding in both front and back end development, I am currently focusing on development with React and Node/Express. </p>
